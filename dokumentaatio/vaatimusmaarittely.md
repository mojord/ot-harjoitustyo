...
- Tekstikäyttöliittymä ei sisällä virheen käsittelyä, koska se toimii graafisen käyttöliittymän tekemisen jälkeen työkaluna ohjelman kehittämiseen. Se on kuitenkin pidetty mukana tarjoamaan sovelluksesta ns. karvalakkiversion.
